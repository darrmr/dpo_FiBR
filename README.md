...
1. **Создайте проект Vite + Vue** (если ещё не создан):
   ```bash
...
### **Пример: карточки книг на Bootstrap**

Создадим мини-приложение для отображения списка книг с использованием Bootstrap-классов.

#### **App.vue**
```vue
<template>
  <div class="container mt-5">
    <h1 class="text-center mb-4">Мои книги</h1>
...
- Карточки (`card`) для отображения книг
...
Разработайте простое Vue-приложение с использованием Bootstrap (или другого CSS-фреймворка на выбор). Тема: «Список фильмов» или «Рецепты».

**Требования:**
- Форма для добавления нового элемента (название, категория)
- Список элементов в виде карточек Bootstrap
- Кнопка удаления элемента
- Адаптивная сетка (например, 1 колонка на мобильных, 3 на десктопе)

**Дополнительно (по желанию):** добавить иконки Bootstrap Icons.
